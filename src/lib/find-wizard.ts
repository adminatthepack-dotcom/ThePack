...
export const FIND_INTENTS: IntentDef[] = [
  ...
  },
  {
    ...
    specsQuestion: "What kind of transport?",
    specs: [
      { value: "ground", label: "Ground transport", tagFilter: "trans-ground" },
      { value: "air", label: "Air / cargo arrangements", tagFilter: "trans-air" },
      { value: "climate", label: "Climate-controlled vehicle", tagFilter: "trans-climate" },
      { value: "international", label: "International", tagFilter: "trans-international" },
      ...
      { value: "puppy", label: "Puppy / litter transport", tagFilter: "trans-litter" },
  ...
  },
  {
    ...
    hint: "Security companies, training academies, agencies hiring K9 teams.",
    role: "employer",
    hideForRoles: ["employer"],
    specsQuestion: "What type of operation?",
    specs: [
      { value: "exec-protection", label: "Executive protection", tagFilter: "executive-protection" },
      { value: "security", label: "Security services", tagFilter: "security" },
      { value: "training-academy", label: "Training academy", tagFilter: "training-academy" },
      { value: "law-enforcement", label: "Law enforcement", tagFilter: "law-enforcement" },
      { value: "military", label: "Military", tagFilter: "military" },
