...
export const APPLY_CONFIGS: Record<ProviderRole, ApplyConfig> = {
  ...
  transporter: {
    ...
    certAgencies: [
      'USDA APHIS AC 309 (Commercial Animal Transporter)',
      'DOT Motor Carrier Number',
      'USDA Interstate Certificate',
    ],
    certNotes:
      'Commercial animal transporters are required to hold a USDA APHIS Animal Transportation Certificate. Upload your license and any relevant insurance documentation.',
    hasOwnDogQuestion: false,
    includeDogsStep: false,
    businessStep: false,
  },
